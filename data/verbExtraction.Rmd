...
some tokens are misclassified as verbs (big issue!!!)
  ...
  - Try taking a sample of verbs and seeing if they were correctly classifed
  in order to make sure not a widespread problem
...
5. For tokens without a CELEX encoding,
  ...
  (i.e. just do our own transcription for all the verbs and don't need to
  replicate what was done in the paper)
