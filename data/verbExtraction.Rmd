...
The code below adds columns for the CELEX transcription of the stem and past tense
used in Kirov and Cotterell (2018).
...
To Do:
1. Not every verb token has a CELEX transcription found in english_merged.txt :(
2. celexToIPA.py doesn't transcribe tokens in the same way as in Kirov and Cotterell (2018)
  - See examples in Table 1 of the paper and compare with correspoding IPA
  transcriptions in verb_tokens_transcribed.csv for reference
3. Figure out whether using American or British IPA